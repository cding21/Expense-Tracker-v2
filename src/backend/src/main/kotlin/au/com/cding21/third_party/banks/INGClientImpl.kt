...
class INGClientImpl(
    ...
    private suspend inline fun <T> withLoggedInSession(permanent: Boolean = false, task: (context: BrowserContext, page: Page) -> T): T {
        ...
        try{
            page.waitForResponseAsync("https://www.ing.com.au/KeypadService/v1/KeypadService.svc/json/PinpadImages", Page.WaitForResponseOptions().setTimeout(10000.0))
            page.waitForResponseAsync("https://www.ing.com.au/KeypadService/v1/KeypadService.svc/json/PinpadImages", Page.WaitForResponseOptions().setTimeout(3000.0))
        ...
        val responseJson = Json.decodeFromString<JsonObject>(page.waitForResponseAsync("https://www.ing.com.au/api/token/login/issue").text())
